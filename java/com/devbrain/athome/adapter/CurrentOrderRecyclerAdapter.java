...
import com.devbrain.athome.activity.CurrentOrderDetailsActivity;
...
public class CurrentOrderRecyclerAdapter extends RecyclerView.Adapter<CurrentOrderRecyclerAdapter.ViewHolder> {
    ...
    public CurrentOrderRecyclerAdapter(Context context, List<OrderInfo> listFileInfos) {
...
//        holder.user_number.setText(orderInfo.getUserMobile() + "");
        ...
        holder.cardView.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                activity.startActivity(new Intent(activity, CurrentOrderDetailsActivity.class));
            }
        });
    }
