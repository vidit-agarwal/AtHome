...
public class CurrentOrderDetailsActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        order_date.setText(String.valueOf(orderInfo.getOrderDate()));
        order_status.setText(orderInfo.getOrderStatus());
        order_amount.setText("Total: Rs " + orderInfo.getTotalPay());
        nameView.setText(String.valueOf(orderInfo.getUserName()));
        addressView.setText(String.valueOf(orderInfo.getOrderAddress()));
        mobileView.setText(String.valueOf(orderInfo.getUserMobile()));
        emailView.setText(String.valueOf(orderInfo.getUserEmail()));
