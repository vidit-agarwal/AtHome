...
import com.devbrain.athome.adapter.OrderHistoryRecyclerAdapter;
...
public class OrderHistoryListActivity extends AppCompatActivity {
    ...
    OrderHistoryRecyclerAdapter orderRecyclerAdapter;
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        orderRecyclerAdapter = new OrderHistoryRecyclerAdapter(this, orderInfoArrayList);
    ...
    public void getOrderList(final Activity activity) {
        ...
        NetworkTransaction.getInstance(activity).ProcessRequest(TransactionType.POST, RestAPIURL.ORDER_HISTORY_URL, jObjDeviceInfo, new NetworkTransactionListener<String>() {
            @Override
